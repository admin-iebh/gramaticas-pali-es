...
<main>
<p class="intro">Cosecha de la sesión 57 sobre Kaccāyana (los ocho capítulos), Rūpasiddhi, Nyāsa y el vol. 2 de Ven. A. Thitzana: lo que ninguna de las tres fuentes del glosario tiene como lema. Las cifras de la columna «fuentes» son apariciones del tema en cada obra. El español y el inglés son <b>propuestas</b>; en cada fila hay sitio para la suya. Marque <b>acepta</b> para que el término entre en el glosario y <b>rechaza</b> para que no entre; lo que quede sin marcar no se toca. <b>Para corregir una propuesta, marque acepta y escriba su versión en «su español» o «su inglés»</b>: lo que escriba ahí sustituye a lo propuesto. «Su nota» es para cualquier otra indicación, que se lee antes de aplicar nada. El trabajo se guarda solo en este navegador; al terminar, <b>Exportar</b> descarga <code>veredictos-terminos-faltantes.json</code>: déjelo en <code>docs/glosario/</code> y avise, o pegue el texto copiado en el chat. Lo aceptado entra en la lista normativa (<code>comun/glosario.md</code>) y en su propuesta inglesa.</p>
<table><thead><tr>
