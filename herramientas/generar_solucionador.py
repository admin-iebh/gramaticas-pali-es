...
NOTA = ("Nuevo MODO REVISIÓN (✎): quien sabe de sandhi marca veredictos "
        "sobre cada voz —la primera lectura es correcta, no es sandhi, u "
        "otra lectura— y los exporta en el formato de los lotes de "
        "adjudicación; nada se adjudica sin firma. Con señal segura se "
