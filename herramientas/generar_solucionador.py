...
NOTA = ("LO REGISTRADO A MANO YA SE VE. Una voz dada de alta por el campo "
        ...
        "clase la identifica la «m» de la juntura, no la segunda voz; la "
        "licencia es la unicidad de la lectura de la clase, con el "
        "resguardo de frecuencia por los dos lados y el desempate de "
        "gemelas a la vocal inicial breve. Afirma sólo dentro del RÉGIMEN "
        "MEDIDO (frecuencia ≥ 159, el alcance del informe): fuera de él el "
        "resguardo se debilita y la medición no llegó, así que las formas "
        "raras callan hasta que el IEBH amplíe la licencia. En la "
        "referencia de señal: 25 formas más con señal segura (18 antes "
        "mudas, 7 antes posibles). "
        "Antes, en la versión 1.10: "
        "LAS OBSERVACIONES YA NO SE PIERDEN. Cada tarjeta del modo revisión "
